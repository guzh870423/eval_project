...
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('aykaranj', 'Abhijit', 'Karanjkar', 'aykaranj@indiana.edu', NOW(), NULL, 'aykaranj');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('arivero', 'Andres', 'Rivero', 'arivero@indiana.edu', NOW(), NULL, 'arivero');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('acsarkis', 'Andrew', 'Sarkisian', 'acsarkis@indiana.edu', NOW(), NULL, 'acsarkis');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('asadana', 'Ankit', 'Sadana', 'asadana@indiana.edu', NOW(), NULL, 'asadana');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('cdingers', 'Chris', 'Ingerson', 'cdingers@indiana.edu', NOW(), NULL, 'cdingers');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('harranga', 'Harini', 'Rangarajan', 'harranga@indiana.edu', NOW(), NULL, 'harranga');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('voraj', 'Jaini', 'Vora', 'voraj@indiana.edu', NOW(), NULL, 'voraj');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('jashjhav', 'Jash', 'Jhaveri', 'jashjhav@indiana.edu', NOW(), NULL, 'jashjhav');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('jaynagle', 'Jay', 'Nagle', 'jaynagle@indiana.edu', NOW(), NULL, 'jaynagle');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('mmlele', 'Mrunal', 'Lele', 'mmlele@indiana.edu', NOW(), NULL, 'mmlele');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('nishshah', 'Nishant', 'Shah', 'nishshah@indiana.edu', NOW(), NULL, 'nishshah');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('pmpande', 'Pranav', 'Pande', 'pmpande@indiana.edu', NOW(), NULL, 'pmpande');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('rohsurve', 'Rohit', 'Surve', 'rohsurve@indiana.edu', NOW(), NULL, 'rohsurve');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('rnedunur', 'Rohith', 'Nedunuri', 'rnedunur@indiana.edu', NOW(), NULL, 'rnedunur');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('bsairamr', 'Sairam', 'Bhairavabhotla', 'bsairamr@indiana.edu', NOW(), NULL, 'bsairamr');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('samvaity', 'Sameeksha', 'Vaity', 'samvaity@indiana.edu', NOW(), NULL, 'samvaity');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('sshivara', 'Shruti', 'Shivaramakrishnan', 'sshivara@indiana.edu', NOW(), NULL, 'sshivara');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('yangsis', 'Sisong', 'Yang', 'yangsis@indiana.edu', NOW(), NULL, 'yangsis');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('vpatani', 'Vivek', 'Patani', 'vpatani@indiana.edu', NOW(), NULL, 'vpatani');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('yketkar', 'Yash', 'Ketkar', 'yketkar@indiana.edu', NOW(), NULL, 'yketkar');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('deng4', 'Yu', 'Deng', 'deng4@indiana.edu', NOW(), NULL, 'deng4');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('guzh', 'Zhenghao', 'Gu', 'guzh@indiana.edu', NOW(), NULL, 'guzh');
insert into student (USER_NAME, FIRST_NAME, LAST_NAME, EMAIL, CREATE_TIME, ALIAS_NAME, LOGIN_KEY) values ('siyer', 'Srivatsan', 'Iyer', 'siyer@indiana.edu', NOW(), NULL, 'siyer');
